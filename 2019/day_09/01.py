...
memory = pd.read_csv(_fileName, sep=',', nrows=1, header=None).values[0].tolist()
    ...
    for i in range(0, blocks):
        if instruction["io"][i] == "i":
            ...
            if instruction["params"][i] == "position":
                ...
                #print ('IN Relative Pos: ', relativePos)
                fetchAddress = relativePos + rb
                #print ('IN Memory Address: ', fetchAddress)
    ...
    for i in range(0, blocks):
        if instruction["io"][i] == "o":
            ...
            if instruction["params"][i] == "position":
                ...
                relativePos = instanceState['memory'][pc + i + 1]
                #print ('OUT Relative Pos: ', relativePos)
                writeAddress = relativePos + rb
                #print ('OUT Memory Address: ', writeAddress)

            extend_memory(writeAddress)
            #print('Write Address: ', writeAddress, ' Output: ', output)
