...
#recursive function to count up all contained bags
def count_containing_bags(bags, startBag = "shiny gold bags"):

    count = 1

    bag = bags[startBag]

    for bagColor, bagCount in bag['contains'].items():
        count += (bagCount * count_containing_bags(bags, startBag = bagColor))
...
# -1 as challenge doesnt include the shiny gold bag itself
sumContainedBags = count_containing_bags(bags, startBag = "shiny gold bags") - 1

print ("Total bags contained : ", sumContainedBags)
